...
Pod::Spec.new do |s|
  s.name             = 'RefreshKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RefreshKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/81556205@qq.com/RefreshKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '81556205@qq.com' => 'shayuan@sensenets.com' }
  s.source           = { :git => 'https://github.com/81556205@qq.com/RefreshKit.git', :tag => s.version.to_s }
